...
public class DeleteComent {
    public static void main(String[] args) throws InterruptedException {
       ...
       // WebElement comentMenu = driver.findElement(By.id("t2827"));
        Actions action = new Actions(driver);
        action.moveToElement(comentMenu).build().perform();
        WebElement deleteComent = driver.findElement(By.id("delete_repost-Shape"));
      //  WebElement deleteComent = driver.findElement(By.cssSelector(".mdspost-comment-controls__item.mdspost-comment-controls__item--delete"));
      //  action.perform();
        deleteComent.click();
